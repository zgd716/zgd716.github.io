...
* www.zgd716.com 显示主页面。
* blog.zgd716.com 对应静态site。
* wp.zgd716.com 对应wordpress。
...
$ sudo touch wp-zgd716-com.conf
$ sudo touch blog-zgd716-com.conf
```

sudo vi blog-zgd716-com.conf，添加：

```
<VirtualHost *:80>
    ServerAdmin intzero@outlook.com
    ServerName blog.zgd716.com
...
sudo vi wp-zgd716-com.conf，添加：

```
<VirtualHost *:80>
    ServerAdmin intzero@outlook.com
    ServerName wp.zgd716.com
...
$ sudo ln -s /etc/apache2/sites-available/www-zgd716-com.conf /etc/apache2/sites-enabled/www-zgd716-com.conf
$ sudo ln -s /etc/apache2/sites-available/blog-zgd716-com.conf /etc/apache2/sites-enabled/blog-zgd716-com.conf
```
